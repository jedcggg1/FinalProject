    ...
    cells: [
      ...
      },
      {
        ...
        source: [
          ...
          "แยกรายวิชาที่คั่นด้วยเครื่องหมายลูกน้ำ (,) หรือช่องว่าง ออกเป็นรายวิชาเดี่ยวเพื่อคำนวณความนิยม"
        ]
      },
      {
        cell_type: "code",
        ...
        outputs: [],
        source: [
          "# แยกข้อมูลกรณีที่กรอกหลายวิชา (คั่นด้วยลูกน้ำ หรือ ช่องว่าง)\n",
          "df['วิชาที่ชอบ'] = df['วิชาที่ชอบ'].astype(str).str.split(r'[, ]+')\n",
          "df_exploded = df.explode('วิชาที่ชอบ')\n",
          "\n",
          "# ลบช่องว่างส่วนเกิน และกรองข้อมูลที่เป็นค่าว่าง (Empty String) ทิ้ง\n",
          "df_exploded['วิชาที่ชอบ'] = df_exploded['วิชาที่ชอบ'].str.strip()\n",
          "df_exploded = df_exploded[df_exploded['วิชาที่ชอบ'] != '']\n",
          "\n",
